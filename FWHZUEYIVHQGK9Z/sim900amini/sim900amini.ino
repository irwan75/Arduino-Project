...
void SendMessage()
{
  ...
  mySerial.println("AT+CMGS=\"+6285756603224\"\r"); // Replace x with mobile number
  delay(1000);
...
void MakeCall()
{
  mySerial.println("ATD+6285756603224;"); // ATDxxxxxxxxxx; -- watch out here for semicolon at the end!!
